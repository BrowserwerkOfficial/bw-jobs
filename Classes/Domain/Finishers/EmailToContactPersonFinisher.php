...
/**
 * EmailToContactPersonFinisher
 */
class EmailToContactPersonFinisher extends AbstractFinisher
{
    /**
     * @var string
     */
    protected $finisherIdentifier = 'EmailToContactPerson';

    /**
     * @var string
     */
    protected $shortFinisherIdentifier = 'EmailToContactPerson';
    ...
    protected function executeInternal()
    {
        ...
        if (empty($subject)) {
            throw new FinisherException('The option "subject" must be set for the EmailToContactPersonFinisher.', 1648126465);
        }
        if (empty($recipientAddress)) {
            throw new FinisherException('The option "recipientAddress" must be set for the EmailToContactPersonFinisher.', 1648126466);
        }
        if (empty($senderAddress)) {
            throw new FinisherException('The option "senderAddress" must be set for the EmailToContactPersonFinisher.', 1648126467);
        }
